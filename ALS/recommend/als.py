...
class ALS(object):
    ...
    def predict_list(self, user_ids, n_items=10):
        """Predict the items ratings by users.
        ...
        Returns:
            list -- 2d list with each element is a list of recommendation of movieId for the given user.
        """

        return [list(dict(self._predict(user_id, n_items)).keys()) for user_id in user_ids]
    
    def predict_df(self, user_ids, n_items=10):
        """Predict the items ratings by users.
